...
void print_entry(unsigned long int entry, unsigned char *e_id);
 ...
 * @e_id:pointer to an array containing the ELF class.
 */
void print_class(unsigned char *e_id)
{
	printf("  Class:                             ");
 ...
 * @e_id: pointer to an array containing the ELF version.
 */
void print_version(unsigned char *e_id)
{
	printf("  Version:                           %d",
 ...
 * @e_id:pointer to an array containing the ELF ABI version.
 */
void print_abi(unsigned char *e_id)
{
